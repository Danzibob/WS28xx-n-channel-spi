//! Utility functions for the encoding of data.
//!
//! These functions respect the restrictions from `timings`-module.
//! This whole module works with and only with a frequency of [`crate::timings::PI_SPI_HZ`].
...
/// The frequency for the SPI device that should be used.
///
/// While this was developed I focused on Raspberry Pi.
/// Works on other Linux systems with SPI device probably too if they have a similar frequency.
/// Otherwise you may need to change the values in `encoding.rs`.
